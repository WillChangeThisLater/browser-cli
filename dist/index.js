...
program
    ...
    try {
        const session = await withTimeout((0, session_1.createSession)({
...
program
    ...
    try {
        ...
        try {
            await (0, inspect_1.inspect)(session.page, selector, { ...options, timeout });
        }
        finally {
            await session.close();
        }
...
program
    ...
    try {
        ...
        try {
            await (0, find_1.find)(session.page, text, { ...options, timeout });
        }
        finally {
            await session.close();
        }
